...
WRITER_SYSTEM = (
    "أنت كاتب قصص قصيرة محترف بالعربية الفصحى (MSA) بأسلوب أدبي تأملي. "
    "أسلوبك سينمائي مشوّق باللغة العربية: الإيقاع المدروس، الأجواء المؤثرة، "
...
اكتب قصة قصيرة جداً (Shorts/TikTok format) باللغة العربية الفصحى وفق هذه القواعد:
...
3) ذروة (30-40 ثانية) — جمل قصيرة، إيقاع سريع، لحظة الذروة القصوى.
...
أنت محرر صارم للقصص القصيرة. اقرأ المسودة التالية وقم بتحسينها:
