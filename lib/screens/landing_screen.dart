            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Arabic horror shorts, generated by AI.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                ...
                builder: (ctx, c) {
                  ...
                  final cards = [
                    _StepCard(
                      ...
                      body: 'One sentence — a fragment of a story. The AI '
                          'expands it into a full Arabic script with beats, '
                          'dialogue, and shot directions.',
                    ),
                    _StepCard(
                      number: '2',
                      title: 'AI generates the video',
                      body: 'Each beat becomes a cinematic clip. Characters '
                          'stay consistent across shots; voices match. You '
                          'review the script before any spending happens.',
                    ),
                    _StepCard(
                      number: '3',
                      title: 'Download or share',
                      body: 'The final video stitches itself together with '
                          'music and captions. Export the script as a '
                          'PDF, share the video anywhere.',
                    ),
                  ];
                  if (wide) {
                    return Row(
...
const _showcase = <_ShowcaseItem>[
  _ShowcaseItem(
    title: 'البئر المهجور',
    tagline: 'Folkloric · 2 min',
    gradient: [Color(0xFFB07F1F), Color(0xFFE7B53C)],
  ),
  _ShowcaseItem(
    title: 'صوت من الجدار',
    tagline: 'Urban · 90 sec',
    gradient: [Color(0xFF8B5CF6), Color(0xFF5B21B6)],
  ),
  _ShowcaseItem(
    title: 'سرير الأسرار',
    tagline: 'Domestic · 2 min',
    gradient: [Color(0xFFEA580C), Color(0xFF9A3412)],
  ),
];
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '1 credit = 1 video clip. Subscribe once, render every month.',
                style: TextStyle(
